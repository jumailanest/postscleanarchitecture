...
class __$$ErrorMessageImplCopyWithImpl<$Res>
    extends _$MainFailureCopyWithImpl<$Res, _$ErrorMessageImpl>
...
class _$ErrorMessageImpl implements _ErrorMessage {
  const _$ErrorMessageImpl({required this.message});
  ...
  @override
  String toString() {
    return 'MainFailure.errorMessage(message: $message)';
  }
...
abstract class _ErrorMessage implements MainFailure {
  const factory _ErrorMessage({required final String message}) =
      _$ErrorMessageImpl;
